...
## **Problem Statement**
Sort a stack such that the biggest items are on top. You can only use an additional temporary stack.
...
- **Output**: Stack [3, 23, 31, 34, 92, 98] (top is 98)
...
2. While input stack is not empty:
   ...
   - While temp stack not empty AND top of temp stack < current:

...
## Problem Statement
Given a list of buildings in the cityscape, return the skyline formed by these buildings. Each building is represented by a triplet [left, right, height]. The skyline is a list of "key points" [x, height] where the height changes.

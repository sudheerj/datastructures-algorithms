...
5. Apply OR operation between reverse bit result and the calculated bit left shifted to place it in reversed position (i.e, `31-i`). The OR operation doesn't change the existing bits in the result.

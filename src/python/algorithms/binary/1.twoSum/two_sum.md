...
3. Calculate the carry of the two numbers using Bitwise AND operation. Also, shift the carry to the left 1. This can be stored in a `temp` variable.
...
6. Repeat steps 3-5 until the carry (`b`) is zero.

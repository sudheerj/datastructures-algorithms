...
of its nodes' values (level by level from left to right).
...
if __name__ == "__main__":
    ...
    # DFS tests
    print(f"DFS Test 1: {level_order_recursive(root1)}")  # [[1], [2, 3], [4, 5, 6, 7]]
    print(f"DFS Test 2: {level_order_recursive(root2)}")  # [[3]]
    print(f"DFS Test 3: {level_order_recursive(None)}")  # []

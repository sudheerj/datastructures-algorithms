package java1.algorithms.graph.graphValidTree;
...
public class GraphValidTree {
    ...
    public static void main(String[] args) {
        ...
        int[][] edges2 = {{0, 1}, {1, 2}, {3, 4}, {5, 6}};
        GraphValidTree graphValidTree = new GraphValidTree();
        System.out.println(graphValidTree.validTree(n1, edges1));
        System.out.println(graphValidTree.validTree(n2, edges2));
    }

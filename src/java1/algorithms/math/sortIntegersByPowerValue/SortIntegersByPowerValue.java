...
public class SortIntegersByPowerValue {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test 1 - lo=12 hi=15 k=2: " + (r1 == 13 ? "[PASS]" : "[FAIL]") + " result=" + r1 + " expected=13");

        int r2 = getKth(7, 11, 4);
        System.out.println("Test 2 - lo=7 hi=11 k=4: " + (r2 == 7 ? "[PASS]" : "[FAIL]") + " result=" + r2 + " expected=7");

        int r3 = getKth(1, 5, 3);
        System.out.println("Test 3 - lo=1 hi=5 k=3: " + (r3 == 4 ? "[PASS]" : "[FAIL]") + " result=" + r3 + " expected=4");

        int r4 = getKth(3, 5, 2);
        System.out.println("Test 4 - lo=3 hi=5 k=2: " + (r4 == 5 ? "[PASS]" : "[FAIL]") + " result=" + r4 + " expected=5");

        int r5 = getKth(1, 3, 1);
        System.out.println("Test 5 - lo=1 hi=3 k=1: " + (r5 == 1 ? "[PASS]" : "[FAIL]") + " result=" + r5 + " expected=1");
    }
}

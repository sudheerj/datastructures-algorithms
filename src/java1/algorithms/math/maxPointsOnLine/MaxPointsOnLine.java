...
public class MaxPointsOnLine {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test 1 - 3 collinear diagonal: " + (r1 == 3 ? "[PASS]" : "[FAIL]") + " result=" + r1 + " expected=3");

        int[][] points2 = {{1,1},{2,2},{3,3},{4,5}};
        int r2 = maxPointsOnLine(points2);
        System.out.println("Test 2 - 3 collinear one outlier: " + (r2 == 3 ? "[PASS]" : "[FAIL]") + " result=" + r2 + " expected=3");

        int[][] points3 = {{0,0},{1,0},{2,0},{3,0}};
        int r3 = maxPointsOnLine(points3);
        System.out.println("Test 3 - 4 collinear horizontal: " + (r3 == 4 ? "[PASS]" : "[FAIL]") + " result=" + r3 + " expected=4");

        int[][] points4 = {{0,0},{2,1},{4,3}};
        int r4 = maxPointsOnLine(points4);
        System.out.println("Test 4 - no 3 collinear fractional slopes: " + (r4 == 2 ? "[PASS]" : "[FAIL]") + " result=" + r4 + " expected=2");

        int[][] points5 = {{0,0}};
        int r5 = maxPointsOnLine(points5);
        System.out.println("Test 5 - single point: " + (r5 == 1 ? "[PASS]" : "[FAIL]") + " result=" + r5 + " expected=1");
    }}

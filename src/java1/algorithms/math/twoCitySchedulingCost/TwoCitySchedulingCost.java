...
public class TwoCitySchedulingCost {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test 1 - [[10,20],[30,200],[400,50],[30,20]]: " + (r1 == 110 ? "[PASS]" : "[FAIL]") + " result=" + r1 + " expected=110");

        int[][] costs2 = {{259,770},{448,54},{926,667},{184,139},{840,118},{577,469}};
        int r2 = twoCitySchedulingCost(costs2);
        System.out.println("Test 2 - 6 people: " + (r2 == 1859 ? "[PASS]" : "[FAIL]") + " result=" + r2 + " expected=1859");

        int[][] costs3 = {{1,2},{3,4}};
        int r3 = twoCitySchedulingCost(costs3);
        System.out.println("Test 3 - [[1,2],[3,4]]: " + (r3 == 5 ? "[PASS]" : "[FAIL]") + " result=" + r3 + " expected=5");

        int[][] costs4 = {{100,1},{1,100}};
        int r4 = twoCitySchedulingCost(costs4);
        System.out.println("Test 4 - [[100,1],[1,100]]: " + (r4 == 2 ? "[PASS]" : "[FAIL]") + " result=" + r4 + " expected=2");

        int[][] costs5 = {{10,10},{10,10}};
        int r5 = twoCitySchedulingCost(costs5);
        System.out.println("Test 5 - [[10,10],[10,10]]: " + (r5 == 20 ? "[PASS]" : "[FAIL]") + " result=" + r5 + " expected=20");
    }
}

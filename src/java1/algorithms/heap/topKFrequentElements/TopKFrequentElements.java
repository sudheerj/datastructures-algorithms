...
public class TopKFrequentElements {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Test 5: " + Arrays.toString(elements.topKFrequent(new int[] { 1, 1, 1, 2, 2, 3, 3, 3, 3 }, 1))); // [3]

        // Test 6: Negative numbers
        System.out.println("Test 6: " + Arrays.toString(elements.topKFrequent(new int[] { -1, -1, 2, 2, 2, 3 }, 2))); // [-1,
                                                                                                                      // 2]
